...
### Usage
Navigating the to the home page http://[host]:[port] in your browser will display to webhook URL you can enter in Plex > Settings > Webhooks. It should be http://[host]:[port]/webhook/plex<br><br>
