...
Right now Plex-TVTime does not support linking multiple TVTime accounts, but support for this is in progress and can be tracked <a href="https://github.com/Zggis/plex-tvtime/issues/5">here</a>. As a temporary workaround you can run multiple instances of Plex-TVTime each with their own webhook configured in Plex, and TVTime account credentials configured in docker.
