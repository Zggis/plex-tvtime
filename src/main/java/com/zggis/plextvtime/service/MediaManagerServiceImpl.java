...
public class MediaManagerServiceImpl implements MediaManagerService {
    ...
    private void processWebhook(PlexWebhook webhook) throws TVTimeException {
        ...
        if (mediaType == null || mediaType.isEmpty() || !mediaType.equals("show") && !mediaType.equals("movie")){
            log.warn(
    ...
    private void sendUserWatchRequest(String tvtimeUser, String mediaId, String mediaType, PlexWebhook webhook) {
